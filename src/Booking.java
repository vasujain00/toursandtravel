...
public class Booking extends javax.swing.JFrame{
    ...
    public void taxifill()
    {
       try{
           String sql = "select vechilenumber from taxi";
...
"(bookingno,dateofbooking,fromp,topp,appkm,taxi,driver,startdate,enddate,"+"advpayment,custname,mobile)"+
    "values(bookingno.nextval,'"+
              jTextField1.getText()+"','"+
              jTextField2.getText()+"','"+
              jTextField3.getText()+"','"+
